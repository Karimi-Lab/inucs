...
#SBATCH --ntasks=100
#SBATCH --mem=500G
#SBATCH --output=slurm-4DNFI1O6IL1Q.pairs.log-20210911
...
time python3.9 ./inucs.py prepare data/H1_chromosome.txt data/H1_nucleosome.txt data/4DNFI1O6IL1Q.pairs -d data/4DNFI1O6IL1Q.pairs.inucs
